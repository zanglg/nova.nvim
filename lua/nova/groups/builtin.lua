...
M.get = function()
    ...
    return {
        ...
        IncSearch      = { fg = colors.background, bg = colors.lime },
        Substitute     = { fg = colors.background, bg = colors.lime },
        ...
        MatchParen     = { fg = colors.background, bg = colors.lime },
        ...
        Search         = { fg = colors.background, bg = colors.lime },
