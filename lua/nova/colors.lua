...
local colors = {
    ...
    soft = {
        ...
        light = {
            ...
            red           = hsl2rgb(350, 0.28, 0.44),
            orange        = hsl2rgb(020, 0.22, 0.42),
            yellow        = hsl2rgb(043, 0.28, 0.38),
            green         = hsl2rgb(123, 0.24, 0.36),
            teal          = hsl2rgb(183, 0.26, 0.36),
            blue          = hsl2rgb(212, 0.30, 0.42),
            violet        = hsl2rgb(248, 0.22, 0.46),
            purple        = hsl2rgb(296, 0.24, 0.43),

            match         = hsl2rgb(076, 0.26, 0.34),
            current_match = hsl2rgb(032, 0.28, 0.37),
            target        = hsl2rgb(188, 0.26, 0.35),
        },
    },
}
