...
local colors = {
    ...
    dim = {
        dark = {
            -- Keep Dim perceptually centered between Default and Soft for the UI ramp.
            foreground    = hsl2rgb(225, 0.12, 0.725),
            comment       = hsl2rgb(225, 0.125, 0.495),
            inconspicuous = hsl2rgb(225, 0.12, 0.405),
            splitline     = hsl2rgb(225, 0.19, 0.282),
            selection     = hsl2rgb(225, 0.218, 0.258),
            popupmenu     = hsl2rgb(225, 0.204, 0.220),
            stripline     = hsl2rgb(225, 0.195, 0.192),
            background    = hsl2rgb(225, 0.237, 0.167),
        ...
        light = {
            -- Light keeps high text readability while the surfaces form a visible, even progression.
            foreground    = hsl2rgb(228, 0.065, 0.255),
            comment       = hsl2rgb(228, 0.04, 0.599),
            inconspicuous = hsl2rgb(225, 0.015, 0.712),
            splitline     = hsl2rgb(225, 0.03, 0.782),
            selection     = hsl2rgb(225, 0.03, 0.831),
            popupmenu     = hsl2rgb(225, 0.03, 0.881),
            stripline     = hsl2rgb(225, 0.03, 0.925),
            background    = hsl2rgb(225, 0.03, 0.9595),

            red           = hsl2rgb(350, 0.46, 0.49),
            orange        = hsl2rgb(020, 0.31, 0.46),
            yellow        = hsl2rgb(045, 0.42, 0.46),
            green         = hsl2rgb(123, 0.31, 0.37),
            teal          = hsl2rgb(173, 0.43, 0.33),
            blue          = hsl2rgb(212, 0.59, 0.43),
            violet        = hsl2rgb(240, 0.36, 0.57),
            purple        = hsl2rgb(301, 0.42, 0.46),

            match         = hsl2rgb(076, 0.37, 0.31),
            current_match = hsl2rgb(032, 0.43, 0.37),
            target        = hsl2rgb(188, 0.38, 0.34),
        },
    },
    soft = {
        dark = {
        ...
        light = {
            ...
            inconspicuous = hsl2rgb(225, 0.02, 0.72),
            splitline     = hsl2rgb(225, 0.03, 0.76),
            selection     = hsl2rgb(225, 0.03, 0.81),
            popupmenu     = hsl2rgb(225, 0.03, 0.86),
            stripline     = hsl2rgb(225, 0.03, 0.90),
            background    = hsl2rgb(225, 0.03, 0.94),

            red           = hsl2rgb(350, 0.32, 0.485),
            orange        = hsl2rgb(020, 0.22, 0.46),
            yellow        = hsl2rgb(045, 0.26, 0.50),
            green         = hsl2rgb(123, 0.21, 0.39),
            teal          = hsl2rgb(173, 0.25, 0.37),
            blue          = hsl2rgb(212, 0.41, 0.43),
            violet        = hsl2rgb(240, 0.24, 0.54),
            purple        = hsl2rgb(301, 0.28, 0.47),

            match         = hsl2rgb(076, 0.23, 0.33),
            current_match = hsl2rgb(032, 0.28, 0.39),
            target        = hsl2rgb(188, 0.23, 0.36),
        },
    },
}
